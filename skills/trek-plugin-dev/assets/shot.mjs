...
try {
    ...
    if (url) {
        ...
        for (const theme of ['light', 'dark']) {
            try {
                await page.goto(`${base}/preview`, {waitUntil: 'networkidle', timeout: 15000})
            } catch { /* retry below */
            }
        ...
        try {
            await capture(page, `${base}/ui/harness.html`, path.resolve(dir, outArg))
        } finally {
